  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <form id="form" class="form-horizontal" role="form" method="POST" action="{{ url('post-add-ad') }}" enctype="multipart/form-data">
              {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group{{ $errors->has('start_time') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="start_time" type="text" class="form-control" name="start_time" value="{{ old('start_time') }}" readonly="">
                        ...
                        <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div style="width: 150px; height: 81px; overflow: hidden;"><img id="image_tag" src="{{ old('image')?old('image'):URL::to('dist/img/default-placeholder.png') }}" style="width: 100%; height: 100%;"></div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group{{ $errors->has('end_time') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="end_time" type="text" class="form-control" name="end_time" value="{{ old('end_time') }}" readonly="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select id="is_active" type="text" class="form-control" name="is_active">
                                    <option value="0" <?php echo !old('is_active')?"selected":""?>>No</option>
                                    <option value="1" <?php echo old('is_active')?"selected":""?>>Yes</option>
                                </select>
                            </div>
                        </div>
